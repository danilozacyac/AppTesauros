...
namespace IUS
{
    ...
    public partial class Informe : Page
    {
        public Informe()
        {
            ...
            {
                InitializeComponent();
                contenido.Source = new Uri(IUSConstants.IUS_RUTA_ANEXOS + "Informe2008.htm",
                    UriKind.Absolute);
        ...
        public Informe(String archivo)
        {
            InitializeComponent();
            Salir.ToolTip = "Regresar a la pantalla anterior";
            WindowTitle = "Documento anexo ";
            contenido.Source = new Uri(IUSConstants.IUS_RUTA_ANEXOS + archivo,
                    UriKind.Absolute);
        }
