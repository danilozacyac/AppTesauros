...
{
    public class EjecutoriaSimplificadaElectoralTO
    {
                /// <summary>
        ...
        public EjecutoriaSimplificadaElectoralTO()
        {
#if STAND_ALONE
        ...
        public String getParteT()
        {
            ...
            else
            {
                ...
                FachadaBusquedaTradicionalClient fachada = new FachadaBusquedaTradicionalClient();
#endif
                EjecutoriaActual = fachada.getEjecutoriaElectoralPorId(Int32.Parse(Id));
                fachada.Close();
                return EjecutoriaActual.ParteT;
            }
        }
