...
namespace mx.gob.scjn.electoral_common.gui.apoyos
{
    ...
    {
        public TesisElectoral Padre { get; set; }
#if STAND_ALONE
        ...
        public void ActualizaVentana()
        {
            ...
            DocumentoLeyTO documento = fachada.getDocumentoLey(this.IdLey, this.IdArticulo, this.IdRef,0);
#else
...
#if STAND_ALONE
                archivo = IUSConstants.IUS_RUTA_ANEXOS+ archivo;
#else
