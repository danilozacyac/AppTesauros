...
#else
#endif
namespace mx.gob.scjn.electoral_common.TO
{
    /// <summary>
    ...
    public class TesisSimplificadaElectoralTO
    {
#if STAND_ALONE
        ...
        public TesisSimplificadaElectoralTO()
        {
        ...
        public String getRubro()
        {
            if (Ius == null)
            {
                return ("Espere un momento, actualizando datos...");
            }
            //ActualizaTesis();
#if SILVERLIGHT
            //if (!Actualizado)
...
#endif
                //fachada = new FachadaBusquedaTradicionalClient();
                tesisActual = fachada.getTesisPorRegistroParaListaElectoral(Ius);
